...
const CACHE = 'nova-shell-v16';
const SHELL = [
  '/offline.html',
  '/manifest.json',
  '/assets/css/app.css?v=16',
  '/assets/css/components.css?v=16',
  '/assets/js/api.js?v=16',
  '/assets/js/ui.js?v=16',
  '/assets/js/transactions.js?v=16',
  '/assets/js/receipt.js?v=16',
...
self.addEventListener('fetch', (event) => {
  ...
  // Versioned CSS/JS (?v=N): cache-first for fast repeat opens
  if (url.searchParams.has('v') && /\.(css|js)$/.test(url.pathname)) {
    event.respondWith(
